  ...
  return (
    <header className="nx-no-print sticky top-0 z-20 flex h-14 shrink-0 items-center gap-3 border-b border-line bg-canvas/80 px-4 backdrop-blur-xl lg:px-5">
      <button
        ...
        className="grid h-9 w-9 shrink-0 place-items-center rounded-[8px] text-ink-3 transition-colors hover:bg-hover hover:text-ink lg:hidden"
      >
        <FiMenu size={18} />
      </button>
      ...
      <Link
        ...
        title="Reminders"
        className="grid h-9 w-9 shrink-0 place-items-center rounded-[8px] text-ink-3 transition-colors hover:bg-hover hover:text-ink"
      >
        <TbBell size={18} />
      </Link>
      <Link
      ...
      <Link
        href="/settings"
        aria-label="Account"
        className="grid h-8 w-8 shrink-0 place-items-center rounded-full bg-accent-soft text-[12px] font-semibold text-accent transition-transform duration-150 hover:scale-105"
      >
