...
export default async function MePage() {
  ...
  return (
    <div className="nx-in mx-auto min-h-screen max-w-[880px] px-5 py-10 lg:px-8">
      ...
      <div className="grid gap-3 sm:grid-cols-3">
        {cards.map((c, i) => (
          <Link
            key={c.label}
            href={c.href}
            className="nx-in group rounded-[14px] border border-line bg-rail p-5 transition-all duration-200 hover:-translate-y-0.5 hover:border-line-strong"
      ...
      <section className="mt-8 rounded-[14px] border border-line bg-rail p-6">
