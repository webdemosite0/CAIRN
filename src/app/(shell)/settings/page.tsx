...
export default async function SettingsPage() {
  ...
  if (!user) {
    return (
      <div className="nx-in mx-auto flex min-h-screen max-w-[420px] flex-col items-center justify-center px-5 text-center">
        ...
        <Link
          href="/login"
          className="mt-6 rounded-[var(--r-control)] btn-grad px-5 py-2.5 text-[14px] font-medium"
        >
          Log in
        </Link>
      </div>
  ...
  return (
    <div className="nx-in mx-auto min-h-screen max-w-[680px] px-5 py-10 lg:px-8">
      ...
      <section className="mt-7 rounded-[var(--r-panel)] border border-line bg-rail">
      ...
      <section className="mt-4 rounded-[var(--r-panel)] border border-line bg-rail">
        <h2 className="border-b border-line px-5 py-3.5 text-[13px] font-medium uppercase tracking-[0.06em] text-ink-3">
          Workspace
        </h2>
      ...
      <section className="mt-4 rounded-[var(--r-panel)] border border-critical/25 bg-critical/6 p-5">
